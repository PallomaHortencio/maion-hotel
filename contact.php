...
if(!empty($name) && !empty($email)) {
    try {
        ...
        $body = "<h2>Pedido de Informa&#231;&#227;o</h2>";
        $body .= "Nome: $name<br />";
        $body .= "Email: $email<br />";
        $body .= "Celular: $celular <br />";
        $body .= "Pa&#237;s: $country <br />";
        $body .= "Mensagem: " . html_entity_decode($message, ENT_QUOTES, 'utf-8');
        $body .= "<br />";
        $body .= "--------------------------------------------------------";
        $body .= "<br />";
        ...
        echo json_encode(array("message" => "Ocorreu um erro ao enviar."));
    }
} else {
    echo 'Error';
}
